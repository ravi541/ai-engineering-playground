...
# mug = r'C:\Users\Raviteja\AVSCODE\ai-engineering-playground\MediaPipe-Library\images\mug.png'
# mug = url_to_array(mug)

mug = cv2.imread(
    r"C:\Users\Raviteja\AVSCODE\ai-engineering-playground\MediaPipe-Library\images\mug.png"
)
