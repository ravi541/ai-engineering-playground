...
eye_classifier = cv2.CascadeClassifier(rC:\Users\Raviteja\AVSCODE\ai-engineering-playground\OPENCV\Haar cascade classifier basic project\haarcascade_eye.xml)# Load the image
# image = cv2.imread(r"C:\Users\Raviteja\OneDrive\Desktop\CNN- Happy or Sad\training\sad\2images2.png")
image = cv2.imread(r"D:\photos\pk,haldi\DCIM\100MSDCF\TEJ01143.JPG")
